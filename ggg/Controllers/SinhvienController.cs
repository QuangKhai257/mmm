...
namespace ggg.Controllers
{
    public class SinhvienController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("masv,hoten,malop,diachi")] Sinhvien sinhvien)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("masv,hoten,malop,diachi")] Sinhvien sinhvien)
        {
            if (id != sinhvien.masv)
            {
                return NotFound();
